        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
                  ...
                  {searchResults.length > 0 ? (
                    <div className="flex max-h-[300px] flex-col overflow-y-auto p-2">
                      {searchResults.map((result) => (
                        ...
                        >
                          {result.imageUrl ? (
                            <img src={result.imageUrl} alt={result.title} className="h-10 w-10 shrink-0 rounded-lg object-cover border border-white/10" />
                          ) : (
                            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-earth-dark/50 text-earth-gold">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="truncate text-xs text-earth-cream/70">{result.category || 'General'}</div>
                          </div>
                        </button>
                      ))}
                    </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div ref={menuRef} className="relative inline-block">
              <button 
                type="button" 
                className="ml-2 inline-flex items-center justify-center rounded-lg p-2 text-earth-cream hover:bg-earth-gold/10 hover:text-earth-gold focus:outline-none focus:ring-2 focus:ring-earth-gold transition" 
              ...
              {isMenuExpanded && (
                <div className="absolute right-0 top-full mt-4 w-48 overflow-hidden rounded-2xl border border-white/10 bg-earth-dark/95 p-2 shadow-xl backdrop-blur-xl">
