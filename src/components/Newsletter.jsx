  ...
  return (
    <section className="home-section py-20">
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-brand-500 via-brand-600 to-emerald-700 p-10 text-center shadow-2xl shadow-brand-500/25 ring-1 ring-white/10 dark:from-brand-600 dark:via-brand-700 dark:to-emerald-900 dark:shadow-[0_24px_80px_rgba(15,157,88,0.35)] dark:ring-brand-300/20 md:p-16">
          ...
          <div className="relative z-10">
            <h2 className="mb-4 text-3xl font-extrabold text-white">Never Miss a Deal</h2>
